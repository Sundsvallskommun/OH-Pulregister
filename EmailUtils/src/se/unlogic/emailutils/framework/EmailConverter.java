		...
		if (email.getAttachments() != null && !email.getAttachments().isEmpty()) {
			...
			MimeMultipart mimeMultipart = new MimeMultipart();
				...
				if(email.getMessage() != null){
				      ...
				      textPart.setText(email.getMessage(), email.getCharset(), email.getMessageContentType());
			...
			message.setText(email.getMessage(), email.getCharset(), email.getMessageContentType());
		}
