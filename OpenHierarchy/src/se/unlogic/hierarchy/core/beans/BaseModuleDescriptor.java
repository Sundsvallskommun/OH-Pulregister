...
public abstract class BaseModuleDescriptor implements ModuleDescriptor, XMLParserPopulateable{
	...
	public void populate(XMLParser xmlParser) throws ValidationException {
		...
		this.adminAccess = xmlParser.getPrimitiveBoolean("adminAccess");
		this.userAccess = xmlParser.getPrimitiveBoolean("userAccess");
		this.anonymousAccess = xmlParser.getPrimitiveBoolean("anonymousAccess");
