...
public abstract class BaseModuleCache<DescriptorType extends ModuleDescriptor, ModuleType extends Module<?>, ListenerType> {
	...
	public abstract void cacheModules(boolean syncWithDB) throws KeyNotCachedException, KeyAlreadyCachedException, SQLException;
	
	public abstract void cacheModules(BlockingQueue<Runnable> taskQueue) throws SQLException;
}
