...
public class MenuItemCache implements ForegroundModuleCacheListener, SectionCacheListener {
	...
	private boolean isSelected(MenuItem menuItem, URIParser uriParser) {
		...
		if(menuItem.getUrl() != null){
			...
			}else if(menuItem.getUrlType() == URLType.RELATIVE_FROM_CONTEXTPATH && (uriParser.getFormattedURI().equals(menuItem.getUrl()) || (uriParser.getFormattedURI().startsWith(menuItem.getUrl() + "/") && !menuItem.useExactUrl()))){
