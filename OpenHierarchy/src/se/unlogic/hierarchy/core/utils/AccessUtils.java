...
public class AccessUtils {
	...
	public static AccessInterface combine(boolean permissive, Collection<AccessInterface> accessInterfaces) {
		...
		if (permissive) {
			...
			//			if (accessInterfaces.iterator().next().getAllowedGroupIDs() != null) {
			//
			//				allowedGroupIDs.addAll(accessInterfaces.iterator().next().getAllowedGroupIDs());
			//			}
			//
			//			if (accessInterfaces.iterator().next().getAllowedUserIDs() != null) {
			//
			//				allowedUserIDs.addAll(accessInterfaces.iterator().next().getAllowedUserIDs());
			//			}
