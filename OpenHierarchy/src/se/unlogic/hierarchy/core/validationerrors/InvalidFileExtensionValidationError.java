...
public class InvalidFileExtensionValidationError extends FileValidationError {
	...
	public InvalidFileExtensionValidationError(String filename, Collection<String> allowedExtensions, String displayName) {

		super("InvalidFileExtension", filename, displayName);

		this.allowedExtensions = allowedExtensions;
	}
	
	public InvalidFileExtensionValidationError(String filename, String allowedExtension, String displayName) {
