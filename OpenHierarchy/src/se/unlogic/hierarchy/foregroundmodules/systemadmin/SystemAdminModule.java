...
public class SystemAdminModule extends AnnotatedForegroundModule {
		...
		if (sectionInterface == null) {
			...
			if (backgroundModules != null) {
				...
				for (BackgroundModuleDescriptor moduleDescriptor : backgroundModules) {
					...
					modulesElement.appendChild(ModuleInfoBean.toXML(doc, moduleDescriptor, ModuleType.BACKGROUND, true, false));
				}
			}
		...
		if (uriParser.size() == 3 && NumberUtils.isInt(uriParser.get(2)) && (simpleSectionDescriptor = this.sectionDAO.getSection(Integer.parseInt(uriParser.get(2)), false)) != null) {
			...
			if (req.getMethod().equalsIgnoreCase("POST")) {
				...
				try {
					...
					systemInterface.getEventHandler().sendEvent(BackgroundModuleDescriptor.class, new CRUDEvent<BackgroundModuleDescriptor>(CRUDAction.ADD, simpleModuleDescriptor), EventTarget.ALL);
		...
		if (uriParser.size() == 3 && NumberUtils.isInt(uriParser.get(2)) && (simpleModuleDescriptor = this.backgroundModuleDAO.getModule(Integer.parseInt(uriParser.get(2)))) != null) {
			...
			if (req.getMethod().equalsIgnoreCase("POST")) {
				...
				if (validationErrors.isEmpty()) {
					...
					systemInterface.getEventHandler().sendEvent(BackgroundModuleDescriptor.class, new CRUDEvent<BackgroundModuleDescriptor>(CRUDAction.UPDATE, simpleModuleDescriptor), EventTarget.ALL);
	...
	public SimpleForegroundModuleResponse deleteBackgroundModule(HttpServletRequest req, HttpServletResponse res, User user, URIParser uriParser) throws SQLException, URINotFoundException, IOException {
		...
		if (uriParser.size() == 3 && NumberUtils.isInt(uriParser.get(2)) && (simpleModuleDescriptor = this.backgroundModuleDAO.getModule(Integer.parseInt(uriParser.get(2)))) != null) {
			...
			systemInterface.getEventHandler().sendEvent(BackgroundModuleDescriptor.class, new CRUDEvent<BackgroundModuleDescriptor>(CRUDAction.DELETE, simpleModuleDescriptor), EventTarget.ALL);
			...
			if (uriParser.size() == 3) {
				...
				if (NumberUtils.isInt(uriParser.get(3)) && (simpleSectionDescriptor = this.sectionDAO.getSection(Integer.parseInt(uriParser.get(3)), true)) != null) {
					...
					if (module.getSectionID() == simpleSectionDescriptor.getSectionID()) {
						...
						systemInterface.getEventHandler().sendEvent(BackgroundModuleDescriptor.class, new CRUDEvent<BackgroundModuleDescriptor>(CRUDAction.UPDATE, module), EventTarget.ALL);
		...
		if ((uriParser.size() == 3 || uriParser.size() == 4) && NumberUtils.isInt(uriParser.get(2)) && (module = this.backgroundModuleDAO.getModule(Integer.parseInt(uriParser.get(2)))) != null) {
			...
			if (uriParser.size() == 3) {
				...
				if (NumberUtils.isInt(uriParser.get(3)) && (simpleSectionDescriptor = this.sectionDAO.getSection(Integer.parseInt(uriParser.get(3)), true)) != null) {
					...
					systemInterface.getEventHandler().sendEvent(BackgroundModuleDescriptor.class, new CRUDEvent<BackgroundModuleDescriptor>(CRUDAction.ADD, module), EventTarget.ALL);
	...
	public SimpleForegroundModuleResponse addFilterModule(HttpServletRequest req, HttpServletResponse res, User user, URIParser uriParser) throws URINotFoundException, SQLException, IOException {
		...
		if (req.getMethod().equalsIgnoreCase("POST")) {
			...
			try {
				...
				systemInterface.getEventHandler().sendEvent(FilterModuleDescriptor.class, new CRUDEvent<FilterModuleDescriptor>(CRUDAction.ADD, simpleModuleDescriptor), EventTarget.ALL);
		...
		if (uriParser.size() == 3 && NumberUtils.isInt(uriParser.get(2)) && (simpleModuleDescriptor = this.filterModuleDAO.getModule(Integer.parseInt(uriParser.get(2)))) != null) {
			...
			if (req.getMethod().equalsIgnoreCase("POST")) {
				...
				if (validationErrors.isEmpty()) {
					...
					systemInterface.getEventHandler().sendEvent(FilterModuleDescriptor.class, new CRUDEvent<FilterModuleDescriptor>(CRUDAction.UPDATE, simpleModuleDescriptor), EventTarget.ALL);
	...
	public SimpleForegroundModuleResponse deleteFilterModule(HttpServletRequest req, HttpServletResponse res, User user, URIParser uriParser) throws SQLException, URINotFoundException, IOException {
		...
		if (uriParser.size() == 3 && NumberUtils.isInt(uriParser.get(2)) && (simpleModuleDescriptor = this.filterModuleDAO.getModule(Integer.parseInt(uriParser.get(2)))) != null) {
			...
			systemInterface.getEventHandler().sendEvent(FilterModuleDescriptor.class, new CRUDEvent<FilterModuleDescriptor>(CRUDAction.DELETE, simpleModuleDescriptor), EventTarget.ALL);
	...
	public SimpleForegroundModuleResponse copyFilterModule(HttpServletRequest req, HttpServletResponse res, User user, URIParser uriParser) throws SQLException, URINotFoundException, IOException {
		...
		if ((uriParser.size() == 3 || uriParser.size() == 4) && NumberUtils.isInt(uriParser.get(2)) && (module = this.filterModuleDAO.getModule(Integer.parseInt(uriParser.get(2)))) != null) {
			...
			systemInterface.getEventHandler().sendEvent(FilterModuleDescriptor.class, new CRUDEvent<FilterModuleDescriptor>(CRUDAction.ADD, module), EventTarget.ALL);
		...
		if (uriParser.size() == 3 && NumberUtils.isInt(uriParser.get(2)) && (simpleSectionDescriptor = this.sectionDAO.getSection(Integer.parseInt(uriParser.get(2)), false)) != null) {
			...
			if (req.getMethod().equalsIgnoreCase("POST")) {
				...
				try {
					...
					systemInterface.getEventHandler().sendEvent(ForegroundModuleDescriptor.class, new CRUDEvent<ForegroundModuleDescriptor>(CRUDAction.ADD, simpleModuleDescriptor), EventTarget.ALL);
		...
		if (uriParser.size() == 3 && NumberUtils.isInt(uriParser.get(2)) && (simpleModuleDescriptor = this.foregroundModuleDAO.getModule(Integer.parseInt(uriParser.get(2)))) != null) {
			...
			if (req.getMethod().equalsIgnoreCase("POST")) {
				...
				if (validationErrors.isEmpty()) {
					...
					systemInterface.getEventHandler().sendEvent(ForegroundModuleDescriptor.class, new CRUDEvent<ForegroundModuleDescriptor>(CRUDAction.UPDATE, simpleModuleDescriptor), EventTarget.ALL);
	...
	public SimpleForegroundModuleResponse deleteForegroundModule(HttpServletRequest req, HttpServletResponse res, User user, URIParser uriParser) throws SQLException, URINotFoundException, IOException {
		...
		if (uriParser.size() == 3 && NumberUtils.isInt(uriParser.get(2)) && (simpleModuleDescriptor = this.foregroundModuleDAO.getModule(Integer.parseInt(uriParser.get(2)))) != null) {
			...
			systemInterface.getEventHandler().sendEvent(ForegroundModuleDescriptor.class, new CRUDEvent<ForegroundModuleDescriptor>(CRUDAction.DELETE, simpleModuleDescriptor), EventTarget.ALL);
			...
			if (uriParser.size() == 3) {
				...
				if (NumberUtils.isInt(uriParser.get(3)) && (simpleSectionDescriptor = this.sectionDAO.getSection(Integer.parseInt(uriParser.get(3)), true)) != null) {
					...
					if (module.getSectionID() == simpleSectionDescriptor.getSectionID()) {
						...
						systemInterface.getEventHandler().sendEvent(ForegroundModuleDescriptor.class, new CRUDEvent<ForegroundModuleDescriptor>(CRUDAction.UPDATE, module), EventTarget.ALL);
		...
		if ((uriParser.size() == 3 || uriParser.size() == 4) && NumberUtils.isInt(uriParser.get(2)) && (module = this.foregroundModuleDAO.getModule(Integer.parseInt(uriParser.get(2)))) != null) {
			...
			if (uriParser.size() == 3) {
				...
				if (NumberUtils.isInt(uriParser.get(3)) && (simpleSectionDescriptor = this.sectionDAO.getSection(Integer.parseInt(uriParser.get(3)), true)) != null) {
					...
					systemInterface.getEventHandler().sendEvent(ForegroundModuleDescriptor.class, new CRUDEvent<ForegroundModuleDescriptor>(CRUDAction.ADD, module), EventTarget.ALL);
		...
		if (uriParser.size() == 3 && NumberUtils.isInt(uriParser.get(2)) && (parentSectionBean = this.sectionDAO.getSection(Integer.parseInt(uriParser.get(2)), false)) != null) {
			...
			if (req.getMethod().equalsIgnoreCase("POST")) {
				...
				try {
					...
					systemInterface.getEventHandler().sendEvent(SectionDescriptor.class, new CRUDEvent<SectionDescriptor>(CRUDAction.ADD, newSectionBean), EventTarget.ALL);
		...
		if (uriParser.size() == 3 && NumberUtils.isInt(uriParser.get(2)) && (simpleSectionDescriptor = this.sectionDAO.getSection(Integer.parseInt(uriParser.get(2)), true)) != null) {
			...
			if (req.getMethod().equalsIgnoreCase("POST")) {
				...
				try {
					...
					systemInterface.getEventHandler().sendEvent(SectionDescriptor.class, new CRUDEvent<SectionDescriptor>(CRUDAction.UPDATE, simpleSectionDescriptor), EventTarget.ALL);
	...
	public SimpleForegroundModuleResponse deleteSection(HttpServletRequest req, HttpServletResponse res, User user, URIParser uriParser) throws NumberFormatException, SQLException, URINotFoundException, IOException {
		...
		if (uriParser.size() == 3 && NumberUtils.isInt(uriParser.get(2)) && (simpleSectionDescriptor = this.sectionDAO.getSection(Integer.parseInt(uriParser.get(2)), false)) != null) {
			...
			if (simpleSectionDescriptor.getParentSectionID() == null) {
				...
				this.systemInterface.getEventHandler().sendEvent(SectionDescriptor.class, new CRUDEvent<SectionDescriptor>(CRUDAction.DELETE, simpleSectionDescriptor), EventTarget.ALL);
			}
	...
	private <T extends XMLParserPopulateable> T parseModuleDescriptor(FileItem fileItem, Class<T> descriptorClazz) throws ValidationException, InstantiationException, IllegalAccessException {
		...
		try {
			...
			if (!docElement.getTagName().equals("module")) {
				...
				log.info("Error parsing descriptor " + FilenameUtils.getName(fileItem.getName()) + ", unable to find module element");

				throw new ValidationException(new UnableToParseFileValidationError(FilenameUtils.getName(fileItem.getName())));
			}
