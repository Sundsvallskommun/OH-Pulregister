...
public class RuntimeInfoModule extends AnnotatedForegroundModule {
	...
	public SimpleForegroundModuleResponse defaultMethod(HttpServletRequest req, HttpServletResponse res, User user, URIParser uriParser) throws Exception {
		...
		documentElement.appendChild(XMLUtils.createElement("SystemLoadAverage", operatingSystemMXBean.getSystemLoadAverage(), doc));

		RuntimeMXBean runtimeMXBean = ManagementFactory.getRuntimeMXBean();
		
		XMLUtils.appendNewElement(doc, documentElement, "JavaVersion", System.getProperty("java.version"));
		XMLUtils.appendNewElement(doc, documentElement, "JavaName", runtimeMXBean.getVmName());
		XMLUtils.appendNewElement(doc, documentElement, "JavaVendor", runtimeMXBean.getVmVendor());
		
		XMLUtils.appendNewElement(doc, documentElement, "ServerName", req.getServerName());
		XMLUtils.appendNewElement(doc, documentElement, "ServerInfo", systemInterface.getServerInfo());
