		...
		<div class="contentitem {cssClass}">
			...
			<xsl:if test="deleteURL">
				<div class="floatright">
           			<a href="{/Document/requestinfo/contextpath}{deleteURL}?redirect={/Document/requestinfo/uri}" title="{$i18n.DeleteLinkTitle}" onclick="return confirm('{$i18n.RemoveModule}?')">
						<img src="{/Document/requestinfo/contextpath}/static/b/{/Document/module/sectionID}/{/Document/module/moduleID}/images/delete.png"/>
					</a>
				</div>
			</xsl:if>
