	...
	<xsl:template match="user">
		...
		<div class="floatleft border full marginbottom">
			...
			<div class="floatright">
				<xsl:choose>
					<xsl:when test="SessionInfo/RawCreationTime">
						<a href="{/Document/requestinfo/currentURI}/{/Document/module/alias}/logoutUser/{userID}/{SessionInfo/RawCreationTime}" title="Logga ut användaren {firstname} {lastname}">
