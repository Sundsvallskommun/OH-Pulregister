...
public abstract class Setting implements Elementable {
	...
	Setting(String id, String name, String description, FormElement formElement, boolean required, boolean disabled) {
	...
	public final Element toXML(Document doc) {
		...
		if(disabled){
			XMLUtils.appendNewElement(doc, attributeElement, "Disabled", "true");
		}
	...
	public abstract List<String> parseAndValidate(List<String> values, List<ValidationError> validationErrors);
