		...
		<div class="contentitem">
			...
			<fieldset>
				...
				<table>
					...
					<tr>
						<td>
							<xsl:value-of select="$i18n.SystemLoadAverage"/>
							<xsl:text>:</xsl:text>
						</td>
						<td>
							<xsl:value-of select="SystemLoadAverage"/>
						</td>
					</tr>															
				</table>																
			</fieldset>			
			...
			<fieldset>
				<legend>
					<img src="{/Document/requestinfo/contextpath}/static/f/{/Document/module/sectionID}/{/Document/module/moduleID}/java.png"/>
					<xsl:text> </xsl:text>
					<xsl:value-of select="$i18n.Java"/>
				</legend>
				...
				<table>
					...
					<tr>
						<td>
							<xsl:value-of select="$i18n.Vendor"/>
							<xsl:text>:</xsl:text>
						</td>
						<td>
			...
			<fieldset>
				<legend>
					<img src="{/Document/requestinfo/contextpath}/static/f/{/Document/module/sectionID}/{/Document/module/moduleID}/info.png"/>
					<xsl:text> </xsl:text>
					<xsl:value-of select="$i18n.ServletContainer"/>
				</legend>
				...
				<table>
					<tr>
						...
						<td>
							<xsl:value-of select="ServerInfo"/>
						</td>
					</tr>
					<tr>
						<td>
							<xsl:value-of select="$i18n.Hostname"/>
							<xsl:text>:</xsl:text>
						</td>
						<td>
