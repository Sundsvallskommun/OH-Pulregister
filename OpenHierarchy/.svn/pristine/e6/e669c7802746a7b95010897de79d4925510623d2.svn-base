...
public class SimpleInvitationAdminModule extends BaseInvitationAdminModule<SimpleInvitation, SimpleInvitationType> {
	...
	protected void createDAOs(DataSource dataSource) throws Exception {
		...
		try {
			...
			if (TableVersionHandler.getTableGroupVersion(dataSource, transactionHandler, SimpleInvitationAdminModule.class.getName()) == null) {
	...
	public void unload() throws Exception {
		...
		systemInterface.getInstanceHandler().removeInstance(SimpleInvitationAdminModule.class, this);
