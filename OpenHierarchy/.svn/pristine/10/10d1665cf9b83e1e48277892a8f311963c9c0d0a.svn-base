...
public abstract class MenuItem implements AccessInterface, Cloneable {
	...
	public boolean useExactUrl() {

		return useExactUrl;
	}

	public void setUseExactUrl(boolean useExactUrl) {

		this.useExactUrl = useExactUrl;
	}
	...
	public final Element toXML(Document doc) {
		...
		if (attributeHandler != null) {
			menuItemElement.appendChild(attributeHandler.toXML(doc));
		}
