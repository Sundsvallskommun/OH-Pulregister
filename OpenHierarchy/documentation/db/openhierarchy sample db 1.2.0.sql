...
INSERT INTO `table_versions` VALUES ('se.unlogic.hierarchy.core.daos.implementations.mysql.MySQLCoreDAOFactory',31),('se.unlogic.hierarchy.foregroundmodules.userproviders.SimpleUserProviderModule',4),('se.unlogic.hierarchy.foregroundmodules.pagemodules.daos.annotated.AnnotatedPageDAOFactory',3),('se.unlogic.hierarchy.foregroundmodules.blog.daos.mysql.MySQLBlogDAOFactory',2),('se.unlogic.hierarchy.foregroundmodules.invitation.SimpleInvitationAdminModule',1),('se.unlogic.hierarchy.foregroundmodules.groupproviders.SimpleGroupProviderModule',3);
