...
<!-- 	</xsl:variable> -->
	...
	<xsl:template name="UserList">
		...
		<xsl:param name="placeholder" select="$i18n.usergrouplist.SearchUsers"/>
		<xsl:param name="showEmail" select="false()"/>
		<xsl:param name="showUsername" select="true()"/>
		...
		<ul class="list-style-type-none margintop usergroup-list" id="{$name}-list">
			...
			<li id="{$name}-template" class="hidden show-email-{$showEmail} show-username-{$showUsername}">
				...
				<div class="floatright">
					<a class="delete" href="#" title="{$i18n.usergrouplist.DeleteUser}:">
						<img class="vertical-align-middle" src="{$document/requestinfo/contextpath}/static/f/{$document/module/sectionID}/{$document/module/moduleID}/pics/user_delete.png" alt="{$i18n.usergrouplist.DeleteUser}" />
					</a>
				</div>
			</li>
	...
	<xsl:template match="value" mode="user">
		...
		<xsl:if test="$name != ''">
			...
			<li id="{$prefix}_{.}" class="{$prefix}-list-entry">
				...
				<div class="floatright">
					<a class="delete" href="#" title="{$i18n.usergrouplist.DeleteUser}: {$name}">
						<img class="vertical-align-middle" src="{$document/requestinfo/contextpath}/static/f/{$document/module/sectionID}/{$document/module/moduleID}/pics/user_delete.png" alt="{$i18n.usergrouplist.DeleteUser}" />
					</a>
				</div>
			</li>
	...
	<xsl:template name="GroupList">
		...
		<xsl:param name="connectorURL"/>
		<xsl:param name="document" select="/Document"/>
		<xsl:param name="placeholder" select="$i18n.usergrouplist.SearchGroups"/>
		<xsl:param name="searchfieldclass" select="''"/>
		...
		<ul class="list-style-type-none margintop usergroup-list" id="{$name}-list">
			...
			<li id="{$name}-template" class="hidden">
				...
				<div class="floatright">
					<a class="delete" href="#" title="{$i18n.usergrouplist.DeleteGroup}:">
						<img class="vertical-align-middle" src="{$document/requestinfo/contextpath}/static/f/{$document/module/sectionID}/{$document/module/moduleID}/pics/group_delete.png" alt="{$i18n.usergrouplist.DeleteGroup}" />
					</a>
				</div>
			</li>
	...
	<xsl:template match="value" mode="group">
		...
		<li id="{$prefix}_{.}" class="{$prefix}-group-list-entry">
			...
			<div class="floatright">
				<a class="delete" href="#" title="{$i18n.usergrouplist.DeleteGroup}: {$name}">
					<img class="vertical-align-middle" src="{$document/requestinfo/contextpath}/static/f/{$document/module/sectionID}/{$document/module/moduleID}/pics/group_delete.png" alt="{$i18n.usergrouplist.DeleteGroup}" />
				</a>
			</div>
		</li>
