...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="i18n.SystemLoadAverage">Average system load</xsl:variable>
	<xsl:variable name="i18n.ServletContainer">Servlet container</xsl:variable>
	
	<xsl:variable name="i18n.Hostname">Hostname</xsl:variable>
	<xsl:variable name="i18n.Java">Java</xsl:variable>
	<xsl:variable name="i18n.Vendor">Vendor</xsl:variable>
</xsl:stylesheet>
