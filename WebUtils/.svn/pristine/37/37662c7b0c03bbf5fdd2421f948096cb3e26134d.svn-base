...
public class URIParser {
	...
	protected final String fullContextPath;
	...
	public URIParser(HttpServletRequest req, String uriPrefix, String uriSuffix) {
		...
		if (formattedURI.length() > 0 && formattedURI.trim() != "") {
			...
			String[] splitArray = formattedURI.split("/");

			ArrayList<String> uriList = new ArrayList<String>(splitArray.length);
			
			for(String uriPart : splitArray){
		...
		fullContextPath = RequestUtils.getFullContextPathURL(req);
	}

	private URIParser(List<String> uriList, String currentURI, String formattedURI, String contextPath, String fullContextPath) {
	...
	public URIParser getNextLevel() {
		...
		return new URIParser(this.uriList, this.currentURI, this.formattedURI, this.contextPath, this.fullContextPath);
	}
	...
	public String getRequestURL(){
		...
		return fullContextPath + formattedURI;
	}
